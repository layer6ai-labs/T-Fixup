...
## Validation Curves
Here we show the training and validation loss curve for T-Fixup model, on IWSLT'14 De-En, after 300 epochs (330k update steps). 
<p align="center">
<img src="https://github.com/layer6ai-labs/T-Fixup/blob/master/TFixup_IWSLT14_LossCurve.png" width="500">
</p>
BLEU score, evaluated using average of 10 checkpoints, reaches 35.73 at epoch 278-287
